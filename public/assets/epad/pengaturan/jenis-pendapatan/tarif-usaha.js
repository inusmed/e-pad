                ...
                bootbox.confirm({
                    ...
                    callback: function(isConfirm) {
                        if(isConfirm) {
                            $.ajax({
                                type: 'POST',
                                url: baseApiUrl+ '/pengaturan/tarif-usaha/store',
                                data: {
        ...
        search: function(company_id, kategori_pajak, reff_pajak, grup_id, kategori_id, subkategori_id, subrekening_id, rekening_id, id) {
            ...
            $('#tabelTarifUsaha').DataTable( {
                ...
                "columns": [
                    ...
                    {
                        data: "periode", className: "center", "width": "10%",
                        render: function (data, type, row, meta) {
                            return data;
                        }
                    },
...
function jenis_pendapatan(company_id, kategori_pajak, reff_pajak, grup_id, kategori_id, subkategori_id, subrekening_id, rekening_id, id, nama)
{
    ...
    tarif_usaha.search(company_id, kategori_pajak, reff_pajak, grup_id, kategori_id, subkategori_id, subrekening_id, rekening_id, id)
}
