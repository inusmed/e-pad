...
@section('title', 'Edit Jenis Pendapatan')
    ...
    <div class="page-content">
        <div class="page-header">
            <h1>
                Jenis Pendapatan
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i><span id="txt_judul"> Edit Jenis Pendapatan</span>
                </small>
            </h1>
        </div>
                ...
                <div class="col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable" id="widget-container-col-12">
                    <div class="widget-box widget-color-dark light-border">
                        <div class="widget-header">
                            <h6 class="widget-title">Edit Jenis Pendapatan <span id="txt_judul_pendapatan"></span></h6>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 col-sm-9 col-md-6 col-lg-4 col-lg-4">
                                                @foreach($optKategoriTax as $key => $tax)
                                                    <div class="radio">
                                                        <label>
                                                            {{ Form::radio('kategoriPajak', $key , false, array('id'=>'kategoriPajak-'.$key, 'class' =>'kategoriPajak', 'disabled' => 'disabled')) }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 col-sm-9 col-md-6 col-lg-4 col-lg-4">
                                                @foreach($optReffPajak as $key => $tax)
                                                    <div class="radio">
                                                        <label>
                                                            {{ Form::radio('ketetapanPajak', $key , false, array('id'=>'reffPajak-'.$key, 'class' =>'reffPajak', 'disabled' => 'disabled')) }}
                                                            <span class="lbl">{{ $tax }}</span>
                                                        </label>
                                                    </div>
                                                @endforeach
