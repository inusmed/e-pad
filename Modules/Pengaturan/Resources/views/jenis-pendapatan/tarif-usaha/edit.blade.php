...
@section('title', 'Pembaharuan Tarif Usaha')
...
@section('content')
    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{ url('pengaturan/tarif-omzet') }}"> Tarif Usaha </a>
            </li>
            
            <li class="active"> Perubahan Data </li>
        </ul>
        <!-- /.breadcrumb -->
    ...
    <div class="page-content">
        <div class="page-header">
            <h1>
                Jenis Pendapatan
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i><span id="txt_judul"> Tambah Tarif Usaha</span>
                </small>
            </h1>
        </div>
                                ...
                                <form class="form-horizontal" role="form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9 col-sm-9 col-md-6 col-lg-8 col-lg-7">
                                                <div class="input-group">
                                                    <input type="text" id="jenis_pendapatan" readonly="readonly" class="form-control search-query" placeholder="Pilih Jenis Pendpatan">
                                                    <span class="input-group-btn">
                                                        <button type="button" id="btn-jenis-pendapatan" class="btn btn-inverse btn-white" disabled>
                                    ...
                                    <div class="clearfix form-actions">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            &nbsp;&nbsp;
                                            <button  id="btn-submit-edit" class="btn btn-info" type="button">
