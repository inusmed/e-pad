...
@section('content')
    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active"> Sub Rekening </li>
        </ul>
        <!-- /.breadcrumb -->
    ...
    <div class="page-content">
        <div class="page-header">
            <h1>
                Master Rekening
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i><span id="txt_judul"> Sub Akun Rekening</span>
                </small>
            </h1>
        </div>
                ...
                <div class="col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable" id="widget-container-col-12">
                    <div class="widget-box widget-color-dark light-border">
                        <div class="widget-header">
                            <h6 class="widget-title">Tambah Sub Rekening</h6>
                                    ...
                                    <fieldset>
                                        ...
                                        <div id="form-status" class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio">
                                                    <label>
                                                        <input name="status" id="aktif" type="radio" class="ace" value="1">
...
@push('scripts')
   ...
   <script type="text/javascript">
    ...
    <script src="{{ url('/assets/epad/pengaturan/mataanggaran/subrekening-akun.js') }}"></script>
@endpush
