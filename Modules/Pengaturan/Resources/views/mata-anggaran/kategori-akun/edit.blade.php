...
@section('content')
    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li> 
                <a href="{{ url('accounts/charts-of-accounts/groups') }}"> Master Rekening </a>
            </li>
    ...
    <div class="page-content">
        <div class="page-header">
            <h1>
                Master Rekening
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i><span id="txt_judul"> Edit Kategori Rekening</span>
                </small>
            </h1>
        </div>
            ...
            <div class="col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable" id="widget-container-col-12">
                <div class="widget-box widget-color-dark light-border">
                    <div class="widget-header">
                        <h6 class="widget-title">Edit Kategori Rekening</h6>
                            ...
                            <form class="form-horizontal" role="form">
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="txtCorpCode" placeholder="Kode Korporasi" class="col-xs-12 col-sm-12 col-lg-3" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div id="form-kodeAkun" class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kode Akun </label>
                                        <div class="col-sm-9">
                                            <input type="text" id="kodeAkun" placeholder="Account Number" class="col-xs-12 col-sm-12 col-lg-6" readonly autocomplete="false">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pembentukkan Tanggal </label>
                                        <div class="col-sm-9">
                                            <input type="text" id="txtCreatedAt" placeholder="Pembaharuan Terakhir" class="col-xs-12 col-sm-12 col-lg-9" readonly autocomplete="false">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pembaharuan Terakhir </label>
                                        <div class="col-sm-9">
                                            <input type="text" id="txtUpdatedAt" placeholder="Pembaharuan Terakhir" class="col-xs-12 col-sm-12 col-lg-9" readonly autocomplete="false">
                                        </div>
                                    </div>
