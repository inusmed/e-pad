    ...
    <div class="page-content">
        <div class="page-header">
            <h1>
                Master Rekening
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i><span id="txt_judul"> Kategori Rekening</span>
                </small>
            </h1>
        </div>
                ...
                <div class="col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable" id="widget-container-col-12">
                    <div class="widget-box widget-color-dark light-border">
                        <div class="widget-header">
                            <h6 class="widget-title">Tabel Kategori Rekening</h6>

                            <div class="widget-toolbar">
                                <a href="{{ url('pengaturan/mata-anggaran/grup') }}" class="btn btn-xs btn-light">
                                    <i class="ace-icon fa fa-arrow-left"></i>
                                    Kembali
                                </a>
                                <a href="{{ url('pengaturan/mata-anggaran/kategori-akun/create/'.$company_id.'?grup_id='.$grup_id.'') }}" class="btn btn-xs btn-danger bigger">
                        ...
                        <div class="widget-body">
                            <div class="table-responsive" id="table-content" style="display: none;">
                                ...
                                <table id="tabelAkunKategori" style="font-size: 12px; width: 100%;" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>No</th>
