...
@section('content')
    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li> 
                <a href="{{ url('pengaturan/mata-anggaran/subkategori-akun/'. $company_id .'?grup_id='. $grup_id.'&kategori_id='.$kategori_id) }}"> Sub Kategori </a>
            </li>
            <li> 
                <a href="{{ url('pengaturan/mata-anggaran/subrekening-akun/'. $company_id .'?grup_id='. $grup_id.'&kategori_id='.$kategori_id.'&subkategori_id='.$subkategori_id.'&subrekening_id='.$subrekening_id) }}"> Sub Rekening  </a>
            </li>
            <li class="active"> Rekening Akun </li>
        </ul>
        <!-- /.breadcrumb -->
                ...
                <div class="col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable" id="widget-container-col-12">
                    <div class="widget-box widget-color-dark light-border">
                        <div class="widget-header">
                            <h6 class="widget-title">Tambah Akun Rekening</h6>
                            ...
                            <div class="widget-main">
                                <form class="form-horizontal" role="form">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kategori Pajak </label>
                                            <div class="col-sm-9">
                                                @foreach($option as $key => $kategori)
                                                    <label style="margin-right:20px;margin-top:6px;">
                                                        {{ Form::radio('kategori', $key , false, array('id'=>'kategori-pajak-'.$key, 'class' =>'kategori', 'disabled' => 'disabled')) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="txtRekUtama" class="chosen-select form-control" style="width:350px;" data-placeholder="Rekening Utama"></select>
                                            </div>
                                        </div>

                                        <div id="form-kategori_id" class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kategori Akun </label>
                                            <div class="col-sm-9">
                                                <select id="kategori_id" class="chosen-select form-control" style="width:350px;" data-placeholder="Pilih Rekening Utama Dahulu"></select>
                                            </div>
                                        </div>

                                        <div id="form-subkategori_id" class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Sub Kategori Akun </label>
                                            <div class="col-sm-9">
                                                <select id="subkategori_id" class="chosen-select form-control" style="width:450px;" data-placeholder="Pilih Rekening Utama Dahulu"></select>
                                            </div>
                                        </div>

                                        <div id="form-subrekening_id" class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Sub Akun </label>
                                            <div class="col-sm-9">
                                                <select id="subrekening_id" class="chosen-select form-control" style="width:450px;" data-placeholder="Pilih Rekening Utama Dahulu"></select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="form-id" class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="id" placeholder="Account Number" class="col-xs-12 col-sm-12 col-lg-6" autocomplete="off" readonly>
                                            </div>
                                        </div>
                                    ...
                                    <div class="clearfix form-actions">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            &nbsp;&nbsp;
                                            <button  id="btn-edit" class="btn btn-info" type="button">
...
@push('scripts')
   ...
   <script type="text/javascript">
    ...
    <script src="{{ url('/assets/epad/pengaturan/mataanggaran/rekening-akun.js') }}"></script>
@endpush
