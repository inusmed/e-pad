...
@section('content')
    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li> 
                <a href="{{ url('pengaturan/mata-anggaran/kategori/'. $company_id .'/'. $grup_id) }}"> Kategori </a>
            </li>
            <li> 
                <a href="{{ url('pengaturan/mata-anggaran/subkategori/'. $company_id .'/'. $grup_id .'/'. $kategori_id .'/'. $subkategori_id) }}"> Sub Kategori </a>
            </li>
            <li> 
                <a href="{{ url('pengaturan/mata-anggaran/subrekening/'. $company_id .'/'. $grup_id .'/'. $kategori_id .'/'. $subkategori_id . '/'.$subrekening_id) }}"> Sub Akun </a>
            </li>
                                ...
                                <form class="form-horizontal" role="form">
                                    ...
                                    <fieldset>
                                            ...
                                            <div class="col-sm-9">
                                                @foreach($option as $key => $kategori)
                                                    <label style="margin-right:20px;margin-top:6px;">
                                                        {{ Form::radio('kategori', $key , false, array('id'=>'kategori-pajak-'.$key, 'class' =>'kategori')) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="txtRekUtama" class="chosen-select form-control" style="width:350px;" data-placeholder="Choose a State..."></select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="form-id" class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="id" placeholder="Account Number" class="col-xs-12 col-sm-12 col-lg-6" autocomplete="off">
                                            </div>
                                        </div>
