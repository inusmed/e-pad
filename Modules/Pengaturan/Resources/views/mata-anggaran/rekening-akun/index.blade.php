                ...
                <div class="col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable" id="widget-container-col-12">
                    <div class="widget-box widget-color-dark light-border">
                        <div class="widget-header">
                            <h6 class="widget-title">Tabel Chart Akun Rekening</h6>

                            <div class="widget-toolbar">
                                <a href="{{ url('pengaturan/mata-anggaran/subrekening-akun/'.$company_id.'?grup_id='.$grup_id.'&kategori_id='.$kategori_id.'&subkategori_id='.$subkategori_id) }}" class="btn btn-xs btn-light">
                                    <i class="ace-icon fa fa-arrow-left"></i>
                                    Kembali
                                </a>
                                <a href="{{ url('pengaturan/mata-anggaran/rekening-akun/create/'.$company_id.'?grup_id='.$grup_id.'&kategori_id='.$kategori_id.'&subkategori_id='.$subkategori_id.'&subrekening_id='.$subrekening_id) }}" class="btn btn-xs btn-danger bigger">
                        ...
                        <div class="widget-body">
                            <div class="table-responsive">
                                ...
                                <table id="tabelAkunRekening" style="font-size: 12px; width: 100%;" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                ...
                <div class="modal-body" style="padding:15px 50px;">
                	<div class="widget-box">
						<div class="widget-header widget-header-flat">
							...
							<h5 class="widget-title">Rekening <span id="txtTitleAcc"></span></h5>
                        </div>
                        ...
                        <div class="widget-body" style="overflow:auto">
							<div class="widget-main">
                                ...
                                <div class="row">
									<div class="col-xs-5 col-sm-4 col-lg-4">
    									<h4><small>Rek. Sub Kategori</small></h4>
    								</div>
    								<div class="col-xs-7 col-sm-8 col-lg-8">
                                        <h4><small>: <span id="txtSubKategoriAkun"></span></small></h4>
									</div>
                                </div>
                                
                                <div class="row">
									<div class="col-xs-5 col-sm-4 col-lg-4">
    									<h4><small>Rek. Sub Akun</small></h4>
    								</div>
    								<div class="col-xs-7 col-sm-8 col-lg-8">
                                        <h4><small>: <span id="txtSubRekeningAkun"></span></small></h4>
									</div>
								</div>
                                ...
                                <input type="hidden" id="data-subkategori" value="">
                                <input type="hidden" id="data-subrekening" value="">
                                <input type="hidden" id="data-kategori-pajak" value="">
