    ...
    <div class="page-content">
        <div class="page-header">
            <h1>
                Master Rekening
                <small>
                    <i class="ace-icon fa fa-angle-double-right"></i><span id="txt_judul"> Sunting Sub Kategori Rekening</span>
                </small>
            </h1>
        </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div id="form-status" class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio">
                                                    <label>
                                                        <input name="status" id="status-active" type="radio" class="ace" value="1" checked>
                                                        <span class="lbl"> Aktif</span>
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input name="status" id="status-inactive" type="radio" class="ace" value="0">
