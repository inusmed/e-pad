...
use Modules\Pengaturan\Entities\Tarif\TarifOmzet;

class TarifOmzetRepository
{
    /**
     * @var mixed
     */
    ...
    /**
     * @param TarifOmzet $tarifOmzet
     */
    public function __construct(TarifOmzet $tarifOmzet)
    {
        $this->model = $tarifOmzet;
    }
    ...
    public function datatable(array $data)
    {
        ...
        if($data->count() > 0)
        {
            ...
            return DataTables::of($tarifOmzet)->make(true);
        }

        /* data tidak ditemukan */
        return response()->json([
            'status'    => false,
            'message'   => 'Data tidak ditemukan, silahkan tambah data terlebih dahulu'
        ], 522);
    }
