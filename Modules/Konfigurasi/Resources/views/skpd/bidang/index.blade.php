                ...
                <div class="col-xs-12 col-sm-12 col-lg-12 widget-container-col ui-sortable" id="widget-container-col-12">
                    <div class="widget-box widget-color-dark light-border">
                        ...
                        <div class="widget-header">
                            <h6 class="widget-title">Tabel Urusan Bidang</h6>
                        </div>
                ...
                <div class="modal-body" style="padding:15px 50px;">
                    <div class="widget-box">
                        <div class="widget-header widget-header-flat">
                            ...
                            <h5 class="widget-title">Bidang <span id="txtJudulAkun"></span></h5>
                        </div>
...
@push('scripts')
    ...
    <script src="{{ url('/assets/epad/konfigurasi/skpd/skpd-bidang.js') }}"></script>
@endpush

@push('scripts')
<script>
    var pages      = 'show';
    var company_id = 'X3B196590X9';
</script>
@endpush