<?php namespace Modules\Akun\Entities;
...
class User extends Authenticatable
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'company_id', 'uuid', 'username', 'email', 'password', 'locale', 'enabled', 'verify', 'suspend', 'code', 'expired_in'];
    ...
    {
        return $this->morphToMany('Modules\Akun\Entities\Company', 'user', 'user_companies', 'user_id', 'company_id');
    }

    public function userCompany()
    {
        return $this->hasOne('Modules\Akun\Entities\UserCompany', 'user_id', 'id');
    }
